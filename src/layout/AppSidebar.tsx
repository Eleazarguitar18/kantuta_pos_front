...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Recargas",
    subItems: [
      { name: "Vender Saldo (Cliente)", path: "/recargas/operacion", pro: false },
      // { name: "Cargar Operadora", path: "/recargas/operacion", pro: false },
      { name: "Historial de Ventas", path: "/recargas/historial-clientes", pro: false },
      { name: "Historial de Fondeos", path: "/recargas/historial-inyecciones", pro: false },
    ],
  },
  {
    icon: <PlugInIcon />,
